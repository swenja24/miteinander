...
function aboutPage(){
  ...
  return `${header('Personenzentriert','Über Linea','Was Linea wichtig ist und woran alle gemeinsam arbeiten.')}${profileCard}${goals}${rules}`;
}
